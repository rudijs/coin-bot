...
export const getTokens = async (axios: any, apiKey: string) => {
  ...
  if (process.env.NODE_ENV !== "test") console.log("==> Fetching ethplorer.io Top 50 tokens by capitalization...")
  ...
  if (process.env.NODE_ENV !== "test") console.log("==> Fetching ethplorer.io Top 50 tokens by volume...")
  ...
  if (process.env.NODE_ENV !== "test") console.log("==> Fetching ethplorer.io Top 50 tokens by operations...")
